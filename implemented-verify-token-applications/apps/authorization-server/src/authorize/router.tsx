...
export const setUpAuthorizeRoute = (baseApp: typeof app) => {
    baseApp.get('/authorize', async (c) => {
        ...
        /**
         * PKCEに関するクエリの検証
         * code_challengeが存在する場合、code_challenge_methodの値がS256でなければエラー
         * 片方だけ存在する場合もエラー
        ...
        /**
         * セッションCookieを確認し、行き先を振り分ける
         * 未認証の場合はログイン画面へ、認証済みの場合は同意画面へリダイレクトする
         */
